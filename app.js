...
var budgetController = (function () {
    ...
    return {
        ...
        calculateBudget: function() {
            ...
            // Expense = 100 and income 300, spent 33.33% = 100/200 = 0.5 * 100
        },
...
var UIController = (function() {
    ...
    return {
        ...
        displayMonth: function() {
            ...
            now = new Date()
            //var christmas = new Date(2019, 1, 25)
...
var controller = (function(budgetCtrl, UICtrl) {
    ...
    var ctrlDeleteItem = function(event) {
        ...
        if (itemID) {
            ...
            updateBudget()
            // 4. Calculate and updatde percentages
            updatePercentages()
